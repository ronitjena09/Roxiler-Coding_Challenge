...
function SalesSummary({ selectedMonth }) {
  ...
  return (<div className="sales_summary">
    <h2 className="sales_heading">Statistics - { selectedMonth ? dist[selectedMonth] : 'All Time' }</h2>
    <div className="sales_summary_container">
      <div className="sub_headings_container">
        <div className="sub_heading">Total Sales        - {totalSoldItems+totalUnsoldItems}</div>
